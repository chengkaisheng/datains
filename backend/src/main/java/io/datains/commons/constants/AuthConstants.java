...
public class AuthConstants {
    ...
    public final static String USER_DATA_FILL_TEMPLATE_NAME = "user_data_fill_template";
    ...
    public final static String ROLE_DATA_FILL_TEMPLATE_NAME = "role_data_fill_template";
    ...
    public final static String DEPT_DATA_FILL_TEMPLATE_NAME = "dept_data_fill_template";
