 ...
 * #L%
 */
package io.datains.mybatis.jsqlparser.statement.alter;

import io.datains.mybatis.jsqlparser.statement.ReferentialAction;
import io.datains.mybatis.jsqlparser.statement.ReferentialAction.Action;
import io.datains.mybatis.jsqlparser.statement.ReferentialAction.Type;
import io.datains.mybatis.jsqlparser.statement.create.table.ColDataType;
import io.datains.mybatis.jsqlparser.statement.create.table.ColumnDefinition;
import io.datains.mybatis.jsqlparser.statement.create.table.Index;
import io.datains.mybatis.jsqlparser.statement.select.PlainSelect;
...
public class AlterExpression implements Serializable {
     ...
     * @deprecated use
     *             {@link #setReferentialAction(Type, Action, boolean)}
     */
    @Deprecated
