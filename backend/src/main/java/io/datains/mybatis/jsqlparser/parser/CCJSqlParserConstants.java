...
public interface CCJSqlParserConstants {
  ...
  int K_TABLES = 291;
  /** RegularExpression Id. */
  int K_TABLESAMPLE = 292;
  /** RegularExpression Id. */
  int K_TABLESPACE = 293;
  /** RegularExpression Id. */
  int K_TRIGGER = 294;
  /** RegularExpression Id. */
  int K_THEN = 295;
  ...
  int K_USER = 318;
  /** RegularExpression Id. */
  int K_SQL_CALC_FOUND_ROWS = 319;
  /** RegularExpression Id. */
  int K_SQL_NO_CACHE = 320;
  /** RegularExpression Id. */
  int K_SQL_CACHE = 321;
  /** RegularExpression Id. */
  int K_USING = 322;
  ...
  int K_SIGNED = 323;
  /** RegularExpression Id. */
  int K_STRING_FUNCTION_NAME = 324;
  /** RegularExpression Id. */
  int K_UNSIGNED = 325;
  /** RegularExpression Id. */
  int K_VALIDATE = 326;
  ...
  int K_WITHOUT = 341;
  /** RegularExpression Id. */
  int K_WITHOUT_ARRAY_WRAPPER = 342;
  /** RegularExpression Id. */
  int K_WORK = 343;
  /** RegularExpression Id. */
  int K_XML = 344;
  ...
  int K_ZONE = 354;
  /** RegularExpression Id. */
  int ST_SEMICOLON = 355;
  /** RegularExpression Id. */
  int OP_GREATERTHANEQUALS = 356;
  /** RegularExpression Id. */
  int OP_MINORTHANEQUALS = 357;
  /** RegularExpression Id. */
  int OP_NOTEQUALSSTANDARD = 358;
  /** RegularExpression Id. */
  int OP_NOTEQUALSBANG = 359;
  /** RegularExpression Id. */
  int OP_CONCAT = 360;
  /** RegularExpression Id. */
  int OP_DOUBLEAND = 361;
  /** RegularExpression Id. */
  int OP_CONTAINS = 362;
  /** RegularExpression Id. */
  int OP_CONTAINEDBY = 363;
  /** RegularExpression Id. */
  int DT_ZONE = 364;
  /** RegularExpression Id. */
  int S_DOUBLE = 365;
  ...
  int HEX_VALUE = 369;
  /** RegularExpression Id. */
  int LINE_COMMENT = 370;
  /** RegularExpression Id. */
  int MULTI_LINE_COMMENT = 371;
  /** RegularExpression Id. */
  int S_PARAMETER = 372;
  /** RegularExpression Id. */
  int S_IDENTIFIER = 373;
  /** RegularExpression Id. */
  int LETTER = 374;
  /** RegularExpression Id. */
  int PART_LETTER = 375;
  /** RegularExpression Id. */
  int UnicodeIdentifierStart = 376;
  /** RegularExpression Id. */
  int Ll = 377;
  /** RegularExpression Id. */
  int Lm = 378;
  ...
  int Nl = 382;
  /** RegularExpression Id. */
  int UnicodeIdentifierExtend = 383;
  /** RegularExpression Id. */
  int Cf = 384;
  /** RegularExpression Id. */
  int Mc = 385;
  ...
  int ESC = 391;
  /** RegularExpression Id. */
  int S_CHAR_LITERAL = 392;
  /** RegularExpression Id. */
  int S_QUOTED_IDENTIFIER = 393;
