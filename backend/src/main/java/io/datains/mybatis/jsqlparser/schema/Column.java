 ...
 * #L%
 */
package io.datains.mybatis.jsqlparser.schema;

import io.datains.mybatis.jsqlparser.expression.ArrayConstructor;
...
public class Column extends ASTNodeAccessImpl implements Expression, MultiPartName {
     ...
     * {@code Foo}.
     *
     * @return an instance of {@link io.datains.mybatis.jsqlparser.schema.Table} representing the table this
