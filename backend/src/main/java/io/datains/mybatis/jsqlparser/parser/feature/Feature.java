 ...
 * #L%
 */
package io.datains.mybatis.jsqlparser.parser.feature;

import io.datains.mybatis.jsqlparser.expression.*;
import io.datains.mybatis.jsqlparser.expression.operators.relational.SupportsOldOracleJoinSyntax;
...
public enum Feature {
     ...
     * "RETURNING expr(, expr)*"
     *
     * @see io.datains.mybatis.jsqlparser.expression.operators.relational.ExpressionList
     */
    ...
    insertValues,
    /**
     * @see io.datains.mybatis.jsqlparser.statement.select.Values
     */
    values,
     ...
     * "RETURNING expr(, expr)*"
     *
     * @see io.datains.mybatis.jsqlparser.statement.select.SelectItem
     */
    updateReturning,
    /**
