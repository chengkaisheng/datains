package io.datains.provider.ext;
...
import io.datains.provider.datasource.DefaultExtDDLProvider;
 ...
 *
 * @author zhangzihang
 * @since 2025-05-13 10:57
 */
@Service("extDmDDLProvider")
public class DmExtDDLProvider extends DefaultExtDDLProvider {
    private static final String creatTableSql =
            "CREATE TABLE \"TABLE_NAME\"" +
                    "Column_Fields" + " STORAGE(ON \"MAIN\", CLUSTERBTR);";
    ...
    private String convertTableFieldsString(String table, List<ExtTableField.TableField> fields, boolean notCreateTable, List<ExtTableField.TableField> fieldsToModify) {
        ...
        if (!notCreateTable && primaryKeyField != null) {
            str.append("NOT CLUSTER PRIMARY KEY(\"")
