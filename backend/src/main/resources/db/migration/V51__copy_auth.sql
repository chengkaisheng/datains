...
delimiter ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `copy_auth`(authSource varchar(255), authSourceType varchar(255),
                                                       authUser varchar(255)) RETURNS varchar(255) CHARSET utf8mb4 COLLATE utf8mb4_general_ci
    READS SQL DATA
BEGIN
