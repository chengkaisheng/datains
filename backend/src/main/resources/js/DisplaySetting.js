...
/* scopeId */
var __vue_scopeId__ = "data-v-bf82e358"
/* moduleIdentifier (server only) */
...
var update = __webpack_require__(61)("2bfe8507", content, true, {});
...
// module
exports.push([module.i, "\n.el-form[data-v-bf82e358]{min-height:300px\n}\n.theme-picker[data-v-bf82e358] div.el-color-picker__trigger{border:none\n}\n.theme-input[data-v-bf82e358] input{padding-left:40px !important\n}\n.theme-input[data-v-bf82e358] span.el-input__prefix{padding-top:3px\n}", "", {"version":3,"sources":["/opt/jenkins-home/workspace/dataease-xpack-plugin/deplugin-xpack-frontend/src/views/xpack/settings/display/index.vue"],"names":[],"mappings":";AACA,0BAA0B,gBAAgB;CACzC;AACD,4DAA4D,WAAW;CACtE;AACD,oCAAoC,4BAA4B;CAC/D;AACD,oDAAoD,eAAe;CAClE","file":"index.vue","sourcesContent":["\n.el-form[data-v-bf82e358]{min-height:300px\n}\n.theme-picker[data-v-bf82e358] div.el-color-picker__trigger{border:none\n}\n.theme-input[data-v-bf82e358] input{padding-left:40px !important\n}\n.theme-input[data-v-bf82e358] span.el-input__prefix{padding-top:3px\n}"],"sourceRoot":""}]);
...
/* import ThemePicker from '@/de-base/business/ThemePicker' */
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    query: function query() {
      ...
      //   this.executeAxios('/system/ui/info', 'get', {}, res => {
      this.executeAxios('/api/display/uiInfo', 'get', {}, function (res) {
        _this.systemParams = res.data;
        _this.systemParams.forEach(function (systemParam) {
          if (systemParam.paramKey === 'ui.openHomePage') {
            systemParam.paramValue = systemParam.paramValue === 'true' ? true : false;
          }
        });
      });
    },
    ...
    save: function save() {
      ...
      this.showSave = false;
      this.show = true;
      this.systemParams.forEach(function (systemParam) {
        if (systemParam.file !== null) {
          var file = systemParam.file;
          var name = file.name + ',' + systemParam.paramKey;
          var newfile = new File([file], name, { type: file.type });
          _this2.files.push(newfile);
          systemParam.file = null;
        }
      });
      var param = this.buildFormData(null, this.files, { 'systemParams': this.systemParams });
      this.executeAxios('/api/display/save', 'post', param, function (response) {
        if (response.success) {
          _this2.query(); // 刷新数据
          _this2.$success(_this2.$t('commons.save_success'));
          window.location.reload();

          /* if (this.themeHasChange) {
            this.$emit('plugin-call-back', {
              eventName: 'set-theme-info',
              eventParam: this.themeVal
            })
          } */

          if (_this2.topMenuColorHasChange) {
            _this2.$emit('plugin-call-back', {
              eventName: 'set-top-menu-info',
              eventParam: _this2.topMenuColorVal
            });
          }

          if (_this2.topMenuActiveColorHasChange) {
            _this2.$emit('plugin-call-back', {
              eventName: 'set-top-menu-active-info',
              eventParam: _this2.topMenuActiveColorVal
            });
          }

          if (_this2.topMenuTextColorHasChange) {
            _this2.$emit('plugin-call-back', {
              eventName: 'set-top-text-info',
              eventParam: _this2.topMenuTextColorVal
            });
          }

          if (_this2.topMenuTextActiveColorHasChange) {
            _this2.$emit('plugin-call-back', {
              eventName: 'set-top-text-active-info',
              eventParam: _this2.topMenuTextActiveColorVal
            });
          }
        } else {
          _this2.$message.error(_this2.$t('commons.save_failed'));
        }
      });
    },
    buildFormData: function buildFormData(file, files, param) {
      ...
      formData.append('request', new Blob([__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(param)], { type: 'application/json' }));
      return formData;
    },
    ...
    uploadLoginImage: function uploadLoginImage(file) {
      this.upload(file, 'ui.loginImage');
    },
    uploadLoginLogo: function uploadLoginLogo(file) {
      this.upload(file, 'ui.loginLogo');
    },
    upload: function upload(file, paramKey) {
      this.systemParams.forEach(function (systemParam) {
    ...
    removeValue: function removeValue(paramKey) {
      this.systemParams.forEach(function (systemParam) {
        if (systemParam.paramKey === paramKey) {
    ...
    themeChange: function themeChange(val) {
      this.themeHasChange = true;
      this.themeVal = val;
    },
    topMenuColorChange: function topMenuColorChange(val) {
      this.topMenuColorHasChange = true;
      this.topMenuColorVal = val;
    },
    topMenuActiveColorChange: function topMenuActiveColorChange(val) {
      this.topMenuActiveColorHasChange = true;
      this.topMenuActiveColorVal = val;
    },
    topMenuTextColorChange: function topMenuTextColorChange(val) {
      this.topMenuTextColorHasChange = true;
      this.topMenuTextColorVal = val;
    },
    topMenuTextActiveColorChange: function topMenuTextActiveColorChange(val) {
      this.topMenuTextActiveColorHasChange = true;
      this.topMenuTextActiveColorVal = val;
    },
    triggerTheme: function triggerTheme(key) {
      if (this.show) return;
      var current = this.$refs[key];
      if (current && current.length > 0) {
        current[0].showPicker = true;
      }
    },
    themeStrChange: function themeStrChange(val) {
      var className = '';
      if (val === 'dark') {
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('el-form',{ref:"systemParams",staticClass:"demo-form-inline",attrs:{"disabled":_vm.show,"size":"small"}},[_c('el-row',_vm._l((_vm.systemParams),function(param,index){return _c('el-col',{key:index},[(param.paramKey==='ui.logo')?_c('el-form-item',{attrs:{"label":_vm.$t('display.logo')}},[_c('el-upload',{staticClass:"upload-demo",staticStyle:{"float":"right","margin-left":"10px"},attrs:{"action":"","accept":".jpeg,.jpg,.png,.gif","on-exceed":_vm.handleExceed,"before-upload":_vm.uploadValidate,"on-error":_vm.handleError,"show-file-list":false,"file-list":_vm.filesTmp,"http-request":_vm.uploadLogo}},[_c('el-button',{staticStyle:{"display":"inline-block"},attrs:{"size":"mini","type":"success","plain":""}},[_vm._v("\n              "+_vm._s(_vm.$t('commons.upload'))+"\n            ")])],1),_vm._v(" "),_c('el-button',{staticStyle:{"float":"right","margin-top":"3px"},attrs:{"size":"mini","type":"danger","plain":""},on:{"click":function($event){return _vm.removeValue('ui.logo')}}},[_vm._v("\n            "+_vm._s(_vm.$t('commons.clear'))+"\n          ")]),_vm._v(" "),_c('el-input',{attrs:{"disabled":true,"placeholder":_vm.$t('display.advice_size')+'：135px * 30px'},model:{value:(param.fileName),callback:function ($$v) {_vm.$set(param, "fileName", $$v)},expression:"param.fileName"}})],1):_vm._e(),_vm._v(" "),(param.paramKey==='ui.loginImage')?_c('el-form-item',{attrs:{"label":_vm.$t('display.loginImage')}},[_c('el-upload',{staticClass:"upload-demo",staticStyle:{"float":"right","margin-left":"10px"},attrs:{"action":"","accept":".jpeg,.jpg,.png,.gif","on-exceed":_vm.handleExceed,"before-upload":_vm.uploadValidate,"on-error":_vm.handleError,"show-file-list":false,"file-list":_vm.filesTmp,"http-request":_vm.uploadLoginImage}},[_c('el-button',{staticStyle:{"display":"inline-block"},attrs:{"size":"mini","type":"success","plain":""}},[_vm._v("\n              "+_vm._s(_vm.$t('commons.upload'))+"\n            ")])],1),_vm._v(" "),_c('el-button',{staticStyle:{"float":"right","margin-top":"3px"},attrs:{"size":"mini","type":"danger","plain":""},on:{"click":function($event){return _vm.removeValue('ui.loginImage')}}},[_vm._v("\n            "+_vm._s(_vm.$t('commons.clear'))+"\n          ")]),_vm._v(" "),_c('el-input',{attrs:{"disabled":true,"placeholder":_vm.$t('display.advice_size')+'：500px * 450px'},model:{value:(param.fileName),callback:function ($$v) {_vm.$set(param, "fileName", $$v)},expression:"param.fileName"}})],1):_vm._e(),_vm._v(" "),(param.paramKey==='ui.loginLogo')?_c('el-form-item',{attrs:{"label":_vm.$t('display.loginLogo')}},[_c('el-upload',{staticClass:"upload-demo",staticStyle:{"float":"right","margin-left":"10px"},attrs:{"action":"","accept":".jpeg,.jpg,.png,.gif","on-exceed":_vm.handleExceed,"before-upload":_vm.uploadValidate,"on-error":_vm.handleError,"show-file-list":false,"file-list":_vm.filesTmp,"http-request":_vm.uploadLoginLogo}},[_c('el-button',{staticStyle:{"display":"inline-block"},attrs:{"size":"mini","type":"success","plain":""}},[_vm._v("\n              "+_vm._s(_vm.$t('commons.upload'))+"\n            ")])],1),_vm._v(" "),_c('el-button',{staticStyle:{"float":"right","margin-top":"3px"},attrs:{"size":"mini","type":"danger","plain":""},on:{"click":function($event){return _vm.removeValue('ui.loginLogo')}}},[_vm._v("\n            "+_vm._s(_vm.$t('commons.clear'))+"\n          ")]),_vm._v(" "),_c('el-input',{attrs:{"disabled":true,"placeholder":_vm.$t('display.advice_size')+'：135px * 30px'},model:{value:(param.fileName),callback:function ($$v) {_vm.$set(param, "fileName", $$v)},expression:"param.fileName"}})],1):_vm._e(),_vm._v(" "),(_vm.showfavicon && param.paramKey==='ui.favicon')?_c('el-form-item',{attrs:{"label":_vm.$t('display.favicon')}},[_c('el-upload',{staticClass:"upload-demo",staticStyle:{"float":"right","margin-left":"10px"},attrs:{"action":"","accept":".jpeg,.jpg,.png,.gif","on-exceed":_vm.handleExceed,"before-upload":_vm.uploadValidate,"on-error":_vm.handleError,"show-file-list":false,"file-list":_vm.filesTmp,"http-request":_vm.uploadFavicon}},[_c('el-button',{staticStyle:{"display":"inline-block"},attrs:{"size":"mini","type":"success","plain":""}},[_vm._v("\n              "+_vm._s(_vm.$t('commons.upload'))+"\n            ")])],1),_vm._v(" "),_c('el-button',{staticStyle:{"float":"right","margin-top":"3px"},attrs:{"size":"mini","type":"danger","plain":""},on:{"click":function($event){return _vm.removeValue('ui.favicon')}}},[_vm._v("\n            "+_vm._s(_vm.$t('commons.clear'))+"\n          ")]),_vm._v(" "),_c('el-input',{attrs:{"disabled":true,"placeholder":_vm.$t('display.advice_size')+'：16px * 16px'},model:{value:(param.fileName),callback:function ($$v) {_vm.$set(param, "fileName", $$v)},expression:"param.fileName"}})],1):_vm._e(),_vm._v(" "),(param.paramKey==='ui.loginTitle')?_c('el-form-item',{attrs:{"label":_vm.$t('display.loginTitle')}},[_c('el-input',{attrs:{"placeholder":"eg：DateEase"},model:{value:(param.paramValue),callback:function ($$v) {_vm.$set(param, "paramValue", $$v)},expression:"param.paramValue"}})],1):_vm._e(),_vm._v(" "),(param.paramKey==='ui.title')?_c('el-form-item',{attrs:{"label":_vm.$t('display.title')}},[_c('el-input',{attrs:{"placeholder":"eg：DateEase"},model:{value:(param.paramValue),callback:function ($$v) {_vm.$set(param, "paramValue", $$v)},expression:"param.paramValue"}})],1):_vm._e(),_vm._v(" "),(param.paramKey==='ui.openHomePage')?_c('el-form-item',{attrs:{"label":_vm.$t('display.openHomePage'),"prop":"open"}},[_c('el-checkbox',{model:{value:(param.paramValue),callback:function ($$v) {_vm.$set(param, "paramValue", $$v)},expression:"param.paramValue"}})],1):_vm._e()],1)}),1)],1),_vm._v(" "),_c('div',[(_vm.showEdit)?_c('el-button',{attrs:{"size":"small"},on:{"click":_vm.edit}},[_vm._v(_vm._s(_vm.$t('commons.edit')))]):_vm._e(),_vm._v(" "),(_vm.showSave)?_c('el-button',{attrs:{"type":"success","disabled":_vm.disabledSave,"size":"small"},on:{"click":_vm.save}},[_vm._v("\n      "+_vm._s(_vm.$t('commons.save'))+"\n    ")]):_vm._e(),_vm._v(" "),(_vm.showCancel)?_c('el-button',{attrs:{"type":"info","size":"small"},on:{"click":_vm.cancel}},[_vm._v(_vm._s(_vm.$t('commons.cancel')))]):_vm._e()],1)],1)}
var staticRenderFns = []
