...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__de_base_api_de_api__ = __webpack_require__(72);
  ...
  methods: {
    ...
    save: function save() {
      ...
      this.$refs.roleForm.validate(function (valid) {
        if (valid) {
          var url = _this.formType === 'add' ? '/plugin/role/create' : '/plugin/role/update';
    ...
    queryAllRoles: function queryAllRoles() {
      var _this2 = this;
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('el-form',{ref:"roleForm",attrs:{"model":_vm.form,"rules":_vm.rule,"size":"small","label-width":"auto","label-position":"right"}},[_c('el-form-item',{attrs:{"label":_vm.$t('commons.name'),"prop":"name"}},[_c('el-input',{model:{value:(_vm.form.name),callback:function ($$v) {_vm.$set(_vm.form, "name", $$v)},expression:"form.name"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":_vm.$t('commons.description'),"prop":"description"}},[_c('el-input',{attrs:{"type":"textarea"},model:{value:(_vm.form.description),callback:function ($$v) {_vm.$set(_vm.form, "description", $$v)},expression:"form.description"}})],1),_vm._v(" "),_c('el-form-item',[_c('el-button',{attrs:{"type":"primary"},on:{"click":_vm.save}},[_vm._v(_vm._s(_vm.$t('commons.save')))]),_vm._v(" "),_c('el-button',{on:{"click":_vm.reset}},[_vm._v(_vm._s(_vm.$t('commons.reset')))])],1)],1)}
var staticRenderFns = []
