        ...
        <el-col :span="8" :offset="8">
          <el-form ref="loginForm" :model="loginForm" :rules="loginRules" size="default">
            ...
            <div v-else class="login-welcome">
              {{ $t('login.welcome') + (uiInfo && uiInfo['ui.title'] && uiInfo['ui.title'].paramValue || '杨浦区城运中心数据填报工具') }}
            </div>
...
import { ldapStatus, oidcStatus, getPublicKey, pluginLoaded, singleSignOn } from '@/api/user'
