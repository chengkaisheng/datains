...
export function componentStyle(chart_option, chart,cstyle = {}) {
  ...
  if (chart.customStyle) {
    ...
    if (customStyle.xAxis && chart.type !== '3d-scatter' && chart.type !== 'map_lines' && (chart.type.includes('bar') || chart.type.includes('line') || chart.type.includes('scatter') || chart.type === 'chart-mix')) {
    ...
    if (customStyle.yAxis && chart.type !== '3d-scatter' && chart.type !== 'map_lines' && ((chart.type.includes('bar') && chart.type !== 'bar-stack-part') || chart.type.includes('line') || chart.type.includes('scatter'))) {
