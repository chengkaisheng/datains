...
export function waterfallBarOption(chart_option, chart, cstyle = {}) {
  ...
  // chart_option.series.unshift(datas)
  return chart_option
}
// extremumBarOption
export function extremumBarOption(chart_option, chart, cstyle = {}) {
  baseBarOption(chart_option, chart, cstyle)
