...
export function areaLineOption(chart_option, chart, cstyle = {}) {
  baseLineOption(chart_option, chart, cstyle)
  ...
  chart_option.series.forEach(function(s, i) {
    ...
    s.itemStyle = {
      borderWidth: newStyle.lineStyle.borderWidth,
      borderColor: newStyle.lineStyle.borderColor,
      color: newStyle.lineStyle.bgColor
      // color: {
      //   type: 'linear',
      //   x: 0,
      //   y: 1,
...
export function poleLineOption(chart_option, chart, cstyle = {}) {
  baseLineOption(chart_option, chart, cstyle)
...
// ladderLineOption
export function ladderLineOption(chart_option, chart, cstyle = {}) {
  baseLineOption(chart_option, chart, cstyle)
