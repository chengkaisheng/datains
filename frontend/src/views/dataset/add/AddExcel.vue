                  ...
                  <el-form-item class="form-item">
                    ...
                    >
                      <el-button
                        ...
                        :disabled="uploading"
                      >
                        <span v-if="!uploading" style="font-size: 12px">{{
                          $t("dataset.upload_file")
                        }}</span>
                        <span v-if="uploading" style="font-size: 12px"
                          ><i class="el-icon-loading" />
                          {{ $t("dataset.uploading") }}</span
                        >
                      </el-button>
                    </el-upload>
                  </el-form-item>
                  ...
                  <el-form :inline="true" size="mini" class="row-style">
                    ...
                    <el-form-item>
                      <div>
                        ...
                        <span class="limit-length-data"
                          >（{{ $t("dataset.preview_100_data") }}）</span
                        >
                      </div>
                    </el-form-item>
                  </el-form>
