...
import { listForm, saveForm, updateFormName, deleteForm, getWithPrivileges, uploadExcelForm, excelUploadAiHandle } from './template'
import { forEach, cloneDeep, find } from 'lodash-es'
import { hasPermission } from '../permission.js'
import DataFillingFormMoveSelector from '@/views/dataFilling/form/MoveSelector.vue'
import FileList from '@/views/datafill/FileList.vue'
export default {
  name: 'DataFillingTemplate',
  components: { DataFillingFormMoveSelector, DeAsideContainer, DeContainer, NoSelect, ViewTable, FileList },
  data() {
    return {
...
<template>
  ...
  >
                    ...
                    <template v-if="data.nodeType === 'folder'">
                      ...
                      >
                        ...
                        <el-dropdown-menu slot="dropdown">
                          ...
                          <el-dropdown-item
                            v-if="hasPermission(data.privileges, 'create_template')"
    ...
    <el-main v-if="activeName === 'template'" style="padding: 0">
      <div class="file-container">
        <FileList ref="fileListRef" :isTemplate="true" :nodeData="nodeData" class="file-content" />
      </div>
    </el-main>
