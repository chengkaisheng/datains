export default {
  ...
  chart: {
    ...
    hc_3d_width: '宽度(%)',
    hc_3d_height: '高度(%)',
    hc_3d_neck_width: '颈部宽度',
    hc_3d_neck_height: '颈部高度',
    hc_3d_funnel_opacity: '曲面透明度',
    reductionRate: '图形大小(%)',
    shadowBlur: '阴影模糊',
    variety_depth: '渐变深度',
    ...
    bar_width: '柱宽',
    bar_gap: '柱间隔',
    pic_carousel_set: '图片轮播设置',
    pic_carousel: '图片展示',
    pic_height: '图片高度',
    table_width_set: '表格宽度',
    adaptWidth: '宽度自适应',
    firstWidthName: '第',
    lastWidthName: '列宽',
    adapt: '自适应',
    ...
    text_position: '字体位置',
    prog_value_color: '数值颜色',
    prog_value_font_size: '数值大小',
    prog_value_font_weight: '数值粗细',
    prog_data_color: '数据颜色',
    ...
    pop_width: '弹窗宽度',
    text_pos_left: '左',
    text_pos_left_inside: '左里',
    text_pos_left_outside: '左外',
    text_pos_center: '中',
    text_pos_right: '右',
    text_pos_right_inside: '右里',
    text_pos_right_outside: '右外',
    text_pos_top: '上',
    text_pos_bottom: '下',
    text_italic: '字体倾斜',
    italic: '倾斜',
    ...
    pie_label_line_first_line_length: '第一条引导线长度',
    pie_label_line_second_line_length: '第二条引导线长度',
    pie_label_line_smooth: '引导线平滑程度',
    pie_label_line_width: '引导线宽度',
    pie_label_line_type: '引导线类型',
    pie_label_line_dash_offset: '引导线虚线偏移量',
    outside: '外',
    center: '中心',
    split: '轴线',
    axis_line: '轴线',
  ...
  panel: {
    ...
    box_fontColor: '字体颜色',
    water_mask: '水印',
    water_mask_title: '水印标题',
    water_mask_font_size: '水印字号',
    water_mask_roate: '水印旋转角度',
    water_mask_color: '水印颜色',
    water_mask_alpha: '水印透明度',
    background: '背景',
