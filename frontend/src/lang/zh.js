export default {
  ...
  member: {
    ...
    password_format_is_incorrect: '有效密码：1-30位',
    old_password: '旧密码',
    new_password: '新密码',
  ...
  chart: {
    ...
    proportion: '占比',
    singleProportion: '单列占比',
    doubleProportion: '双列占比',
    proportionOne: '第一列',
    proportionTwo: '第二列',
    percent: '百分比',
    display: '字段展示',
  ...
  wizard: {
    welcome_title: '欢迎使用杨浦区城运中心数据填报工具',
